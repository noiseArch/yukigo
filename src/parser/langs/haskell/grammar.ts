...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "concatenation", "symbols": ["comparison", "_", {"literal":"++"}, "_", "concatenation"], "postprocess": (d) => ({ type: "concatenation", operator: d[2].value, left: d[0], right: d[4] })},
    ...
    {"name": "addition", "symbols": ["multiplication", "_", {"literal":"+"}, "_", "addition"], "postprocess": (d) => ({ type: "addition", operator: d[2].value, left: d[0], right: d[4] })},
    {"name": "addition", "symbols": ["multiplication", "_", {"literal":"-"}, "_", "addition"], "postprocess": (d) => ({ type: "subtraction", operator: d[2].value, left: d[0], right: d[4] })},
    {"name": "addition", "symbols": ["multiplication"], "postprocess": (d) => d[0]},
    {"name": "multiplication", "symbols": ["infix_operator_expression", "_", {"literal":"*"}, "_", "multiplication"], "postprocess": (d) => ({ type: "multiplication", operator: d[2].value, left: d[0], right: d[4] })},
    {"name": "multiplication", "symbols": ["infix_operator_expression", "_", {"literal":"/"}, "_", "multiplication"], "postprocess": (d) => ({ type: "division", operator: d[2].value, left: d[0], right: d[4] })},
    ...
    {"name": "field", "symbols": ["identifier", "_", {"literal":"::"}, "_", "type_list"], "postprocess": (d) => ({type: "Field", name: d[0], contents: d[4]})},
    {"name": "function_type_declaration", "symbols": ["identifier", "_", {"literal":"::"}, "_", "type_list"], "postprocess": (d) => parseFunctionType([d[0], d[4]])},
    ...
    {"name": "pattern", "symbols": [{"literal":"("}, "_", "pattern", "pattern$ebnf$2", "_", {"literal":")"}]},
