...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "addition", "symbols": ["multiplication", "_", {"literal":"+"}, "_", "addition"], "postprocess": (d) => ({ type: "Arithmetic", operator: d[2].value, left: d[0], right: d[4] })},
    {"name": "addition", "symbols": ["multiplication", "_", {"literal":"-"}, "_", "addition"], "postprocess": (d) => ({ type: "Arithmetic", operator: d[2].value, left: d[0], right: d[4] })},
    {"name": "addition", "symbols": ["multiplication"], "postprocess": (d) => d[0]},
    {"name": "multiplication", "symbols": ["infix_operator_expression", "_", {"literal":"*"}, "_", "multiplication"], "postprocess": (d) => ({ type: "Arithmetic", operator: d[2].value, left: d[0], right: d[4] })},
    {"name": "multiplication", "symbols": ["infix_operator_expression", "_", {"literal":"/"}, "_", "multiplication"], "postprocess": (d) => ({ type: "Arithmetic", operator: d[2].value, left: d[0], right: d[4] })},
