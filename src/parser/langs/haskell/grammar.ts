...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "infix_operator_expression", "symbols": ["application", "_", {"literal":"`"}, "_", (HSLexer.has("variable") ? {type: "variable"} : variable), "_", {"literal":"`"}, "_", "infix_operator_expression"], "postprocess": (d) => parseInfixApplication([d[4], d[0], d[8]])},
    ...
    {"name": "composition_expression", "symbols": [(HSLexer.has("variable") ? {type: "variable"} : variable), "_", {"literal":"."}, "_", (HSLexer.has("variable") ? {type: "variable"} : variable)], "postprocess": (d) => parseCompositionExpression([d[0], d[4]])},
    ...
    {"name": "field_exp", "symbols": [(HSLexer.has("variable") ? {type: "variable"} : variable), "_", {"literal":"="}, "_", "expression"], "postprocess": (d) => ({type: "FieldExpression", name: d[0], expression: d[4]})},
    ...
    {"name": "if_expression", "symbols": [{"literal":"if"}, "_", "expression", "_", "if_expression$ebnf$1", "_", {"literal":"then"}, "_", "expression", "_", "if_expression$ebnf$2", "_", {"literal":"else"}, "_", "expression"], "postprocess": (d) => parseConditional([d[2], d[6], d[10]])},
    ...
    {"name": "data_declaration$ebnf$2$subexpression$1", "symbols": ["__", {"literal":"|"}, "__", "constructor_def"]},
    ...
    {"name": "data_declaration", "symbols": [{"literal":"data"}, "__", (HSLexer.has("constructor") ? {type: "constructor"} : constructor), "data_declaration$ebnf$1", "_", {"literal":"="}, "_", "constructor_def", "data_declaration$ebnf$2"], "postprocess": (d) => parseDataDeclaration([d[2], d[7].name, d[7].fields])},
    ...
    {"name": "constructor_def$ebnf$3", "symbols": [(HSLexer.has("NL") ? {type: "NL"} : NL)], "postprocess": id},
    {"name": "constructor_def$ebnf$3", "symbols": [], "postprocess": () => null},
    {"name": "constructor_def", "symbols": [(HSLexer.has("constructor") ? {type: "constructor"} : constructor), "_", "constructor_def$ebnf$1", (HSLexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "constructor_def$ebnf$2", "field_list", "_", "constructor_def$ebnf$3", "_", (HSLexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": (d) => ({name: d[0].value, fields: d[8]})},
    {"name": "constructor_def$ebnf$4", "symbols": []},
    {"name": "constructor_def$ebnf$4$subexpression$1", "symbols": ["_", "type"]},
    ...
    {"name": "field_list", "symbols": ["field", "field_list$ebnf$1"], "postprocess": (d) => ([d[0], ...d[1].map(x => x[5])])},
    {"name": "field", "symbols": [(HSLexer.has("variable") ? {type: "variable"} : variable), "_", (HSLexer.has("typeEquals") ? {type: "typeEquals"} : typeEquals), "_", "type"], "postprocess": (d) => ({type: "Field", name: d[0], value: d[4]})},
    {"name": "function_type_declaration", "symbols": [(HSLexer.has("variable") ? {type: "variable"} : variable), "_", (HSLexer.has("typeEquals") ? {type: "typeEquals"} : typeEquals), "_", "type", "_"], "postprocess": (d) => parseFunctionType([d[0], d[4]])},
    ...
    {"name": "function_declaration", "symbols": [(HSLexer.has("variable") ? {type: "variable"} : variable), "__", "function_declaration$ebnf$1", "_", "function_declaration$ebnf$2", "guarded_rhs"], "postprocess": (d) => parseFunction({type: "function", name: d[0], params: d[2] ? d[2] : [], body: d[5], return: d[5], attributes: ["GuardedBody"]})},
    ...
    {"name": "function_declaration", "symbols": [(HSLexer.has("variable") ? {type: "variable"} : variable), "__", "function_declaration$ebnf$3", "_", (HSLexer.has("assign") ? {type: "assign"} : assign), "_", "function_declaration$ebnf$4", "expression"], "postprocess": (d) => parseFunction({type: "function", name: d[0], params: d[2] ? d[2] : [], body: d[7], return: d[7], attributes: ["UnguardedBody"]})},
    ...
    {"name": "guarded_branch$ebnf$1$subexpression$1", "symbols": [(HSLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    {"name": "guarded_branch$ebnf$1", "symbols": ["guarded_branch$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "guarded_branch$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "guarded_branch", "symbols": [{"literal":"|"}, "_", "expression", "_", {"literal":"="}, "_", "expression", "_", "guarded_branch$ebnf$1"], "postprocess": (d) => ({ condition: d[2], body: d[6], return: d[6] })},
    ...
    {"name": "pattern", "symbols": ["as_pattern"]},
    {"name": "pattern", "symbols": ["constructor_pattern"]},
    {"name": "pattern", "symbols": ["list_pattern"]},
    {"name": "pattern", "symbols": ["tuple_pattern"]},
    {"name": "pattern", "symbols": ["record_pattern"]},
    {"name": "pattern", "symbols": ["literal_pattern"]},
    {"name": "pattern", "symbols": ["variable_pattern"]},
    {"name": "pattern", "symbols": ["wildcard_pattern"]},
    {"name": "pattern", "symbols": ["paren_pattern"]},
    {"name": "wildcard_pattern", "symbols": [(HSLexer.has("anonymousVariable") ? {type: "anonymousVariable"} : anonymousVariable)], "postprocess":  (d) => ({
          type: "WildcardPattern",
          value: "_"
        }) },
    {"name": "variable_pattern", "symbols": [(HSLexer.has("variable") ? {type: "variable"} : variable)], "postprocess": (d) => d[0]},
    ...
    {"name": "literal_pattern", "symbols": ["literal_pattern$subexpression$1"], "postprocess": (d) => parsePrimary(d[0][0])},
    {"name": "as_pattern$subexpression$1", "symbols": ["variable_pattern"]},
    {"name": "as_pattern$subexpression$1", "symbols": ["wildcard_pattern"]},
    {"name": "as_pattern", "symbols": ["as_pattern$subexpression$1", "_", {"literal":"@"}, "_", "pattern"], "postprocess":  (d) => ({
          type: "AsPattern",
          alias: d[0],
          pattern: d[4]
        }) },
    ...
    {"name": "field_pattern", "symbols": [(HSLexer.has("variable") ? {type: "variable"} : variable), "_", {"literal":"="}, "_", "pattern"], "postprocess": (d) => ({ field: d[0].value, pattern: d[4] })},
    ...
    {"name": "type_variable", "symbols": [(HSLexer.has("variable") ? {type: "variable"} : variable)], "postprocess": (d) => ({ type: "TypeVar", name: d[0].value })},
